...
export class BotService {
    ...
    async createOrderBotMessage(order: Order) {
        ...
        const takeOrderOptions = {
            inline_keyboard: [
                [{ text: 'Открыть заявку', url: `https://t.me/orders_formaster_bot/orders_app?startapp=${order.Id}` }],
            ],
        };
    ...
    async takeOrderBotMessage(chatId: string, messageId: string, orderId: string) {
        ...
        const OrderOptions = {
            inline_keyboard: [
                [{ text: 'Открыть заявку', url: `https://t.me/orders_formaster_bot/orders_app?startapp=${orderId}` }],
            ],
        };
